...
class Venus_Slider_Widget extends WP_Widget {
    ...
    public function __construct() {
            $widget_ops = array(
                    'classname'     => 'widget_venus_slider',
                    'description'   => __( 'Easily display carousels of images, videos, and posts.', 'venus-slider' ),
            );
            parent::__construct( 'widget_venus_slider', __( 'Venus Slider', 'venus-slider' ), $widget_ops );
    }
    ...
    public function form( $instance ) {
            ...
            if ( count( $carousels ) > 0 ) {
                    ...
                    echo sprintf( '<p><label for="%1$s">%2$s</label>', $this->get_field_id( 'title' ), __( 'Title (optional):', 'venus-slider' ) );
                    ...
                    echo sprintf( '<p><label>%s</label>', __( 'Choose Slide', 'venus-slider' ) );
                    ...
                    echo sprintf( '<p>%1$s <a href="' . admin_url( 'post-new.php?post_type=venus-carousels' ) . '">%3$s</a> %2$s</p>',
                            __( 'You did not add any carousel slider yet.', 'venus-slider' ),
                            __( 'to create a new carousel slider now.', 'venus-slider' ),
                            __( 'click here', 'venus-slider' )
			        );
            }
    }
...
add_action( 'widgets_init', function() {
        register_widget( 'Venus_Slider_Widget' );
} );