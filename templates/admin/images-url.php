...
<div data-id="open" id="section_url_images_settings" class="shapla-toggle shapla-toggle--stroke"
	...
	<span class="shapla-toggle-title">
		<?php esc_html_e( 'URL Images', 'venu-slider' ); ?>
	</span>
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
			...
			$this->form->images_url( array(
				'id'   => '_images_urls',
				'name' => esc_html__( 'Images URLs', 'venu-slider' ),
				'desc' => esc_html__( 'Enter external images URLs.', 'venu-slider' ),
			) );
			?>
        </div>
    </div>
...
<!-- The Modal -->
<div id="VenusSliderModal" class="venu_slider-modal">

    <!-- Modal content -->
    <div class="venu_slider-modal-content">
        <div class="venu_slider-modal-header">
            <span class="venu_slider-close">&times;</span>
			<?php esc_html_e( 'Image Carousel - from URL', 'venu-slider' ); ?>
        </div>
        <div class="venu_slider-modal-body">
            <div id="venu_slider_form" class="venu_slider-form">
				<?php if ( is_array( $_images_urls ) ): foreach ( $_images_urls as $image ): ?>
                    <div class="venu_slider-fields">
                        <label class="setting">
                            <span class="name"><?php esc_html_e( 'URL', 'venu-slider' ); ?></span>
                            <input type="url" name="_images_urls[url][]" value="<?php echo $image['url']; ?>"
                                   autocomplete="off">
                        </label>
                        <label class="setting">
                            <span class="name"><?php esc_html_e( 'Title', 'venu-slider' ); ?></span>
                            <input type="text" name="_images_urls[title][]" value="<?php echo $image['title']; ?>"
                                   autocomplete="off">
                        </label>
                        <label class="setting">
                            <span class="name"><?php esc_html_e( 'Caption', 'venu-slider' ); ?></span>
                            <textarea name="_images_urls[caption][]"><?php echo $image['caption']; ?></textarea>
                        </label>
                        <label class="setting">
                            <span class="name"><?php esc_html_e( 'Alt Text', 'venu-slider' ); ?></span>
                            <input type="text" name="_images_urls[alt][]" value="<?php echo $image['alt']; ?>"
                                   autocomplete="off">
                        </label>
                        <label class="setting">
                            <span class="name"><?php esc_html_e( 'Link To URL', 'venu-slider' ); ?></span>
        ...
        <div class="venu_slider-modal-footer">
            <button class="button button-primary" id="save_carousel_images_urls">
				<?php esc_html_e( 'Save', 'venu-slider' ); ?>
            </button>
        </div>
    </div>
