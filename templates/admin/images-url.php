...
<div data-id="open" id="section_url_images_settings" class="shapla-toggle shapla-toggle--stroke"
    ...
    <span class="shapla-toggle-title">
        <?php _e( 'URL Images', 'venus-slider' ) ?>
    </span>
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
            ...
            $this->form->images_url( array(
                'id'   => '_images_urls',
                'name' => __( 'Images URLs', 'venus-slider' ),
                'desc' => __( 'Enter external images URLs.', 'venus-slider' ),
            ) );
            ?>
        </div>
    </div>
