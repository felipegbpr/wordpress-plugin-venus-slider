<div data-id="open" id="section_images_settings" class="shapla-toggle shapla-toggle--stroke"
	...
	<span class="shapla-toggle-title">
		<?php esc_html_e( 'Media Images', 'venu-slider' ); ?>
	</span>
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
			...
			$this->form->images_gallery( array(
				'id'   => '_wpdh_image_ids',
				'name' => esc_html__( 'Carousel Images', 'venu-slider' ),
				'desc' => esc_html__( 'Choose carousel images from media library.', 'venu-slider' ),
			) );
			?>
        </div>
    </div>
