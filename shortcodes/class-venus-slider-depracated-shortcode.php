...
if ( ! class_exists( 'Venus_Slider_Deprecated_Shortcode' ) ):

    class Venus_Slider_Deprecated_Shortcode {
        private $plugin_path;
         ...
         * 
         * @return Venus_Slider_Deprecated_Shortcode
        */
        ...
        /**
         * Venus_Slider_Deprecated_Shortcode constructor
         */
        ...
        public function carousel( $atts, $content = null ) {
                ...
                ob_start();
                require $this->plugin_path . '/template/carousel.php';
...
Venus_Slider_Deprecated_Shortcode::init();